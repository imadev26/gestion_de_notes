...
$grp = new Groupes();
$allgrps = $grp->selectfil("Groupes",$cnx);
$getfil = New filieres();
...
if (isset($_POST["submit"])) {
    ...
    $objectgrp = (object) $grpbeta;
    $grp->updategrp($objectgrp,"Groupes",$cnx,$id);
}
            ...
            <div class="page-wrapper relative ltr:ml-auto rtl:mr-auto rtl:ml-0 w-[calc(100%-260px)] px-4 pt-[64px] duration-300">
                            ...
                            <div class="w-full">                    
                                <div class="flex flex-wrap justify-between">
                                    <div class="items-center ">
                                        <h1 class="font-medium text-3xl block dark:text-slate-100">Modifier un groupe</h1>
                                        <ol class="list-reset flex text-sm">
                                            <li><a href="#" class="text-gray-500 dark:text-slate-400">Groupes</a></li>
                                            <li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
                                            <li class="text-primary-500 hover:text-primary-600 dark:text-primary-400">Modifier un groupe</li>
                                        </ol>
                                    </div><!--end /div-->
                ...
                <table class="w-full" id="tableProf">
                    <thead class="bg-slate-700 dark:bg-slate-900/30">
                        <?php 
                        echo '<tr>';
                        foreach ($allgrps[0] as $key => $value) {
                    ...
                    <tbody>
                            <?php 
                             foreach ($allgrps as $row) {
                                echo '<tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">';
                                echo "<td class='p-3 text-sm font-medium whitespace-nowrap dark:text-white'>" . $row["idgrp"] . "</td>" . "<td class='p-3 text-sm font-medium whitespace-nowrap dark:text-white'>" . $row["nomgrp"] . "</td>" . "<td class='p-3 text-sm font-medium whitespace-nowrap dark:text-white'>" . $grp->returnID($cnx,$row["filiére"]) . "</td>";
                                ...
                                <a href="../delete.php?type=groupe&id='.$row["idgrp"].'"><i class="icofont-ui-delete text-lg text-red-500 dark:text-red-400"></i></a>
                            </td></tr>';
                            }
                            ?> 
    ...
    <div class="popup-container" id="popup">
        ...
        editButtons.forEach(function (button, index) {
            button.addEventListener('click', function () {
                ...
                document.getElementById('idgrp').innerHTML = rowData[0].innerText;
                document.getElementById('grpID').value = rowData[0].innerText;
                document.getElementById('nomgrp').value = rowData[1].innerText;
            });
        });
