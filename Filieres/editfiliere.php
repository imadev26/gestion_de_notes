...
$fil = New filieres();
$allfil = $fil->selectfil("Filieres",$conn);
if (isset($_POST["submit"])) {
    $filiere = $_POST["nomfil"];
    $idfil = $_POST["idfil"];
    $fil->updatefil($filiere ,'Filieres',$conn,$idfil);
    ...
    <body data-layout-mode="light"  data-sidebar-size="default" data-theme-layout="vertical" class="bg-[#EEF0FC] dark:bg-gray-900">
        ...
        <div class="ltr:flex flex-1 rtl:flex-row-reverse">
            <div class="page-wrapper relative ltr:ml-auto rtl:mr-auto rtl:ml-0 w-[calc(100%-260px)] px-4 pt-[64px] duration-300">
                            ...
                            <div class="w-full">                    
                                <div class="flex flex-wrap justify-between">
                                    <div class="items-center ">
                                        <h1 class="font-medium text-3xl block dark:text-slate-100">Modifier un Filiére</h1>
                                        <ol class="list-reset flex text-sm">
                                            <li><a href="#" class="text-gray-500 dark:text-slate-400">Filiéres</a></li>
                                            <li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
                                            <li class="text-primary-500 hover:text-primary-600 dark:text-primary-400">Modifier un Filiére</li>
                                        </ol>
                                    </div><!--end /div-->
                ...
                ?>
                <table class="w-full" id="tablefil">
                    <thead class="bg-slate-700 dark:bg-slate-900/30">
                        <?php 
                        echo '<tr>';
                        foreach ($allfil[0] as $key => $value) {
                    ...
                    <tbody>
                            <?php 
                             foreach ($allfil as $row) {
                                ...
                                echo "<td class='p-3 text-sm font-medium whitespace-nowrap dark:text-white'>" . $row["idfiliere"] . "</td>" . "<td class='p-3 text-sm font-medium whitespace-nowrap dark:text-white'>" . $row["libelleF"] . "</td>";
                                ...
                                <a href="../delete.php?type=fililere&id='.$row["idfiliere"].'"><i class="icofont-ui-delete text-lg text-red-500 dark:text-red-400"></i></a>
                            </td></tr>';
                            }
                            ?> 
    ...
    <div class="popup-container" id="popup">
        ...
        editButtons.forEach(function (button, index) {
            button.addEventListener('click', function () {
                ...
                document.getElementById('idfil').innerHTML = rowData[0].innerText;
                document.getElementById('valID').value = rowData[0].innerText;
                document.getElementById('nomfil').value = rowData[1].innerText;
            });
        });
