                        ...
                        <tbody>
                            ...
                            foreach ($alluser as $row) {
                              ...
                              echo '<td class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">' . $row['ID'] . '</td>' .
                                  ...
                                  '<td><a id="btn-ens" class="btn trigger"><i class="icofont-teacher text-slate-500 dark:text-slate-300 text-center text-[30px]" onclick="handleButtonClick(' . $row['ID'] . ')"></i></a></td>' . '</tr>';
                            }
                            ?>
                        </tbody>
                    </table>
